...
export type CommonCheckboxVisualState = 'default' | 'hover' | 'pressed';

export interface CommonCheckboxProps extends React.ComponentPropsWithoutRef<
  typeof CheckboxPrimitive.Root
> {
  isError?: boolean;
  visualState?: CommonCheckboxVisualState;
  size?: number;
}

export const CommonCheckbox = React.forwardRef<
